...
{
    public class DesignDraftPreviewViewComponent : ViewComponent
    {
        #region Matriz sley
        ...
        public IViewComponentResult Invoke(int cols, int rows, int ends, string data, string sley, string puntos, string repeats, int? x, string coordMalas2)
        {
